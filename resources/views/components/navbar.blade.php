    ...
    <nav class="flex flex-col space-y-1 text-xs font-bold leading-tight">
        ...
        @auth
            ...
            @elseif(auth()->user()->hasRole('user'))
                <a href="{{ route('user.dashboard') }}" 
                    class="px-3 py-2 rounded flex items-center gap-3 {{ request()->routeIs('user.dashboard') ? 'bg-[#1F7D53] text-white' : 'hover:underline' }}">
                    <i class="fas fa-grip-horizontal text-lg text-gray-400"></i>
                    Dashboard
                </a>
            @endif
        ...
        @hasanyrole('admin|superadmin')
            ...
            <a href="{{ route('analytics.carbon') }}" 
                class="px-3 py-2 rounded flex items-center gap-3 {{ request()->routeIs('analytics.carbon') ? 'bg-[#1F7D53] text-white' : 'hover:underline' }}">
            ...
            <a href="{{ route('pages.notifications') }}" 
                class="px-3 py-2 rounded flex items-center gap-3 {{ request()->routeIs('pages.notifications') ? 'bg-[#1F7D53] text-white' : 'hover:underline' }}">
        ...
        @hasanyrole('user')
            ...
            <a href="{{ route('pages.notifications.filter') }}" 
            class="px-3 py-2 rounded flex items-center gap-3 {{ request()->routeIs('pages.notifications.filter') ? 'bg-[#1F7D53] text-white' : 'hover:underline' }}">
            ...
            <a href="{{ route('harvests.upcoming') }}" 
                class="px-3 py-2 rounded flex items-center gap-3 {{ request()->routeIs('harvests.upcoming') ? 'bg-[#1F7D53] text-white' : 'hover:underline' }}">
        ...
        @hasanyrole('admin|superadmin')
            <a href="{{ route('pages.harvest-management') }}" 
                class="px-3 py-2 rounded flex items-center gap-3 {{ request()->routeIs('pages.harvest-management') ? 'bg-[#1F7D53] text-white' : 'hover:underline' }}">
                <i class="fa-solid fa-chart-pie text-lg text-gray-400"></i>
                Harvest Management
            </a>
            <a href="{{ route('pages.backup') }}" 
                class="px-3 py-2 rounded flex items-center gap-3 {{ request()->routeIs('pages.backup') ? 'bg-[#1F7D53] text-white' : 'hover:underline' }}">
                <i class="fa-solid fa-bars-progress text-lg text-gray-400"></i>
                Backup
            </a>
            <a href="{{ route('feedback.index') }}" 
                class="px-3 py-2 rounded flex items-center gap-3 {{ request()->routeIs('feedback.index') ? 'bg-[#1F7D53] text-white' : 'hover:underline' }}">
                <i class="fa-solid fa-comment text-lg text-gray-400"></i>
                Manage Feedback
            </a>
            <a href="{{ route('pages.activity-log') }}" 
                class="px-3 py-2 rounded flex items-center gap-3 {{ request()->routeIs('pages.activity-log') ? 'bg-[#1F7D53] text-white' : 'hover:underline' }}">
                <i class="fa-solid fa-list-check text-md text-gray-400"></i>
                Activity Log
            </a>
            <a href="{{ route('pending-geotags.index') }}" 
                class="px-3 py-2 rounded flex items-center gap-3 {{ request()->routeIs('pending-geotags.index') ? 'bg-[#1F7D53] text-white' : 'hover:underline' }}">
        ...
        @role('superadmin')
            <a href="{{ route('pages.accounts') }}" 
                class="px-3 py-2 rounded flex items-center gap-3 {{ request()->routeIs('pages.accounts') ? 'bg-[#1F7D53] text-white' : 'hover:underline' }}">
        ...
        @role('admin')
            <a href="{{ route('admin.user_table') }}" 
                class="px-3 py-2 rounded flex items-center gap-3 {{ request()->routeIs('admin.user_table') ? 'bg-[#1F7D53] text-white' : 'hover:underline' }}">
                <i class="fa-solid fa-user text-lg text-gray-400"></i>
                User
            </a>
        @endrole
        ...
        @role('user')
            <a href="{{ route('feedback.create') }}" 
                class="px-3 py-2 rounded flex items-center gap-3 {{ request()->routeIs('feedback.create') ? 'bg-[#1F7D53] text-white' : 'hover:underline' }}">
                <i class="fa-solid fa-comment text-lg text-gray-400"></i>
                Feedback
            </a>
        @endrole
