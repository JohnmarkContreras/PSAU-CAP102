    ...
    <div class="row content-container">
        <?php echo $__env->make('voyager::dashboard.navbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php if(auth()->check() && auth()->user()->hasRole('superadmin')): ?>
                <div class="text-right p-3 bg-warning text-dark">
                    <a href="<?php echo e(route('superadmin.dashboard')); ?>" class="btn btn-sm btn-primary superadmin-dashboard-link">
                        <i class="voyager-home"></i> Back to Main Dashboard
                    </a>
                </div>
            <?php endif; ?>
        ...
        <script>
            (function(){
                   ...
                   /* ensure the superadmin link sits above any overlays and can receive pointer events */
            })();
        </script>
        <!-- Main Content -->
...
<?php /**PATH /var/www/PSAU-CAP102/resources/views/vendor/voyager/master.blade.php ENDPATH**/ ?>