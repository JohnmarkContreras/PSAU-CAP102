...
<?php $__env->startSection('content'); ?>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const labels = <?php echo json_encode(['Sour', 'Sweet', 'Semi-Sweet']) ?>;
        const data = <?php echo json_encode([ $totalsour ?? 0, $totalsweet ?? 0, $totalsemi_sweet ?? 0 ]) ?>;
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const RAW_HARVESTS = <?php echo json_encode($harvests->toArray(), 15, 512) ?>;
...
<?php $component = $__env->getContainer()->make(App\View\Components\Card::class, ['title' => 'Dashboard']); ?>
                        ...
                        <div class="p-4 flex flex-col items-center justify-center text-center">
                            <div class="flex items-center justify-center mb-2">
                                <div class="text-center">
                                        <div class="text-2xl font-bold"><?php echo e($totaltrees); ?></div>
                    ...
                    <!-- Total Pending Card -->
                        <div class="bg-[#255F38] text-white rounded-md shadow-md overflow-hidden w-full">
                            ...
                            <div class="p-4 flex flex-col items-center justify-center text-center">
                                <div class="flex items-center justify-center mb-2">
                                    <div class="text-center">
                                        <div class="text-2xl font-bold"><?php echo e($pendingtree); ?></div>
                        ...
                        <div class="bg-[#04471C] text-white rounded-md shadow-md overflow-hidden w-full">
                            ...
                            <div class="p-4 flex flex-col items-center justify-center text-center">
                                <div class="flex items-center justify-center mb-2">
                                    <div class="text-center">
                                        <div class="text-2xl font-bold"><?php echo e(number_format($totalActual, 2)); ?> kg</div>
                    ...
                    <!-- Total Carbon Sequestration Card -->
                        <div class="bg-[#0c2d1c] text-white rounded-md shadow-md overflow-hidden w-full">
                            ...
                            <div class="p-4 flex flex-col items-center justify-center text-center">
                                <div class="flex items-center justify-center mb-2">
                                    <div class="text-center">
                                        <div class="text-2xl font-bold"><?php echo e($totalAnnualSequestrationKg); ?>kg co2</div>
...
document.getElementById('harvestFilterForm').addEventListener('submit', function(e) {
    ...
    fetch("<?php echo e(route('harvest.filter')); ?>?" + params, {
        headers: {
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const totals = <?php echo json_encode($totals, 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/PSAU-CAP102/resources/views/pages/dashboard.blade.php ENDPATH**/ ?>